...
#include "../include/yocs_keyop/keyop.hpp"
                 ...
                 key_file_descriptor_(0)
{
  ...
  sub_value = nh.subscribe("/amcl_pose",100,&KeyOp::PoseCallback,this);
}
...
void KeyOp::PoseCallback(const geometry_msgs::PoseWithCovarianceStamped &Now_pose)
{
...
void KeyOp::spin()
{
  ros::Rate loop_rate(100); //default 10
...
void KeyOp::set_point()
{
    ...
    std::ofstream fout( "/home/leishen/catkin_zz/src/yujin_ocs-devel/yocs_keyop/param/pose_param.yaml" );
    fout << node;
    i++;
    ROS_INFO("%d",i);
}
